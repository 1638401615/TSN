...
InnerBuffer::InnerBuffer(unsigned short portIndex, uint8_t pcp, uint32_t capacity) : m_portIndex(portIndex), m_pcp(pcp), m_capacity(capacity), m_residualCapacity(capacity), m_usedCapacity(0) {
